...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Ayush Gahtori", job: "Yoga Trainer" },
    { img: Trainer2, name: "Ayush Gahtori", job: "Crossfit Trainer" },
    { img: Trainer3, name: "Ayush Gahtori", job: "Personal Trainer" },
  ];
